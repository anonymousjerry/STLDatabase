...
const CategoryItem = ({ title, children, href }: CategoryItemProps) => {
  return (
    <Link href={href}>
      <div className="flex flex-col gap-2 py-3 px-1 items-center aspect-square w-full h-[140px] sm:h-[160px] cursor-pointer border-[1px] border-[#C8C8C833] transition bg-custom-light-containercolor  text-black hover:rounded-2xl  hover:border-[#b6e400] hover:shadow-[0_0_16px_0_rgba(0,0,0,0.32)]">
        <div className="flex ">
          {children}
        </div>
