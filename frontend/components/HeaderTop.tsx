...
const HeaderTop = () => {
  ...
  return (
    ...
    <div className="h-[46px] text-white bg-custom-bgcolor max-lg:px-5 max-lg:h-16 max-[573px]:px-0">
      <div className="flex justify-between h-full max-lg:flex-col max-lg:justify-center max-lg:items-center max-w-screen-2xl mx-auto px-12 max-[573px]:px-0">
        <ul className="flex items-center h-full gap-x-5 max-[370px]:text-sm max-[370px]:gap-x-2">
          <li className="flex items-center gap-x-2 font-inter ">
            <p className="text-[#ffffff] text-left font-['Inter-Light',_sans-serif] text-base font-light relative">
              Platform Center
            </p>
          </li>
          <li className="flex items-center gap-x-2 font-inter ">
            <p className="font-light text-base leading-none tracking-normal">
              |
            </p>
          </li>
          <li className="flex items-center gap-x-2 font-inter">
