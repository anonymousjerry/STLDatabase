...
const HeaderMain = () => {
    ...
    return (
        <div className="bg-[url('/Header_bg.png')] bg-cover bg-center  shrink-0 h-auto min-h-[300px] sm:min-h-[350px] lg:min-h-[441px] relative py-6 sm:py-8">
            <Container className="flex flex-col gap-4 sm:gap-6 lg:gap-8 items-start justify-start">
