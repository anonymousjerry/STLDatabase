...
const AdminSingleOrder = () => {
  ...
  useEffect(() => {
    const fetchOrderData = async () => {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/orders/${params?.id}`
      );
    ...
    const fetchOrderProducts = async () => {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/order-product/${params?.id}`
      );
  ...
  const updateOrder = async () => {
    if (
      ...
      fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/orders/${order?.id}`, {
        method: "PUT", // or 'PUT'
        headers: {
  ...
  const deleteOrder = async () => {
    ...
    fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/order-product/${order?.id}`,
      requestOptions
    ).then((response) => {
      fetch(
