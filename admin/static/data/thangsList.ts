export const thangsList: [string, string][] = [
    ["3D Printers", "Anker"], ["3D Printers", "Anycubic"], ["3D Printers", "Bambu Lab"], ["3D Printers", "Cocoa Press"], ["3D Printers", "Creality"], ["3D Printers", "Elegoo"],
